...
class ExecutionCommandException extends \Exception
{
    ...
    {
        return new static(
            "Docker image build command execution error Returned code: $code. Command is $command, error msg is: ".var_export($msg, true)
        );
    }
    ...
    {
        return new static(
            "Docker image push command execution error Returned code: $code. Command is $command, error msg is: ".var_export($msg, true)
        );
    }
